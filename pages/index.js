         ...
         <div className="row d-flex justify-content-between align-items-center text-lg-start text-center ps-xl-5 mb-lg-5">
            <div className="col-xl-6 col-lg-7 col-xs-12">
               <div className="mb-3 my-lg-2 my-md-5 ps-xl-4 pt-xl-4">
                  ...
                  <p className="mb-3 ps-lg-1 mt-3 pt-1">Introducing your own dedicated AI outreach platform that <br/>will allow you to manage/scale your online presence.</p>
                     ...
                     {isSuccess ? (
                        ...
                        <div className="signup_form position-relative d-flex flex-column justify-content-lg-start justify-content-center mt-3 mt-lg-3 mt-md-2 pt-1">
                           ...
                           <div className="d-flex flex-lg-row flex-column mb-3 ">
                              ...
                              <div className="signup_button rounded-pill border-0 py-3 mt-md-1 mt-lg-0 d-flex justify-content-center">
                              <button type="submit" class="bg-transparent border-0 text-white d-flex justify-content-between align-items-center">
                                 <span>Early Access</span> <span className="arr_icon">&nbsp;</span>                     
                              </button>       
                              </div>  
